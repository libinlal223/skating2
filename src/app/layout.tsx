...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.smartwheelsskating.com'),
  ...
  keywords: [
    ...
    'skating coach India',
    'Guinness World Record skating',
  ],

  authors: [{ name: 'SmartWheels Skating Academy' }],

  alternates: {
    canonical: 'https://www.smartwheelsskating.com',
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/skating_action.png',
        width: 1200,
        height: 630,
        alt: 'SmartWheels Skating Academy',
      }
    ],
  },
